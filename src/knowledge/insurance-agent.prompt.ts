...
- When the retrieved knowledge-base content contains a \`Portal navigation result\`, respond with its \`Message\`, a blank line, and its \`URL\` exactly as provided. When it contains \`missingParameter: contractId\`, ask exactly: \`Could you please provide the contract ID?\`
